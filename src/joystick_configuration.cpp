...
{
  std::string romea_joy_share_directory = ament_index_cpp::get_package_share_directory("romea_joy");
  std::string joystick_configuration_file = romea_joy_share_directory+"/config/"+joystick_type+".yaml";
