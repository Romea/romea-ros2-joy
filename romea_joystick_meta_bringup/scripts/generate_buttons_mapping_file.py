...
import sys
import yaml
from romea_joystick_meta_bringup import JoystickMetaDescription, generate_buttons_mapping_file
...
if __name__ == "__main__":
    ...
    with open(teleop_remapping_file_path, 'r') as f:
        print(generate_buttons_mapping_file(meta_description, yaml.safe_load(f)))
