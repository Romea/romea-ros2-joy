...
def get_joystick_configuration_file_path(joystick_manufacturer, joystick_model, joystick_driver):
    pkg_path = get_package_share_directory("romea_joystick_description")
    return f"{pkg_path}/config/{joystick_manufacturer}_{joystick_model}_{joystick_driver}.yaml"


def get_joystick_configuration(joystick_manufacturer, joystick_model, joystick_driver):
    with open(
